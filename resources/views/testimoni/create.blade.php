...
<div class="card">
	<div class="card-body">
		<nav class="navbar bg-success" style="border-radius: 2px;">
			<h4 class="text-white mb-0">Tambah Testimoni</h4>
		</nav>
    <form class="col-lg-12 col-md-12 mt-4" action="{{url('/admin/testimoni/add')}}" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <div class="form-group">
        ...
        <input placeholder="Nama"" value="{{ old('nama') }}" type="text" class="form-control" id="nama" name="nama" maxlength="200">
      </div>
      <div class="form-group">
        <label for="kota">Kota</label>
        <input placeholder="Kota"" value="{{ old('kota') }}" type="text" class="form-control" id="kota" name="kota" maxlength="200">
      </div>
      <div class="form-group">
