...
<div class="card">
	<div class="card-body">
		<nav class="navbar bg-success" style="border-radius: 2px;">
			<h4 class="text-white mb-0">Tambah Paket Pendidikan</h4>
		</nav>
    <form class="col-lg-12 col-md-12 mt-4" action="{{url('/admin/paket-pendidikan/add')}}" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <div class="form-group">
        ...
        <input placeholder="Deskripsi Singkat" value="{{ old('deskripsi_singkat') }}" type="text" class="form-control" id="deskripsi_singkat" name="deskripsi_singkat" maxlength="200" required>
      </div>
      <div class="form-group">
