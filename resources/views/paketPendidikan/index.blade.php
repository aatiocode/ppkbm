...
<div>
    ...
    <div class="d-flex flex-row-reverse">
      <a href="{{url('/admin/paket-pendidikan/add')}}" class="btn btn-success mb-2" role="button" title="add news"><i class="fas fa-plus-circle mr-2 fa-lg"></i>Tambah Paket Pendidikan</a>
    </div>
		<div class="card mb-2">
                  ...
                  <th scope="col">Status</th>
                    ...
                    <td class="align-middle text-truncate max-width">
                      ...
                      @endphp
                        ...
                        <a href="{{url('/admin/paket-pendidikan/'.base64_encode($artikelData->id).'/edit?view=true')}}" class="text-success">
                          <i class="fa fa-eye"></i>
                        </a>
                        <a href="{{url('/admin/paket-pendidikan/'.base64_encode($artikelData->id).'/edit')}}" class="text-info mx-2">
		...
		@else
			@component('components.card')
				@slot('link')
        {{url('/')}}/admin/paket-pendidikan/add
				@endslot
				@slot('label')
					Paket Pendidikan
				@endslot
