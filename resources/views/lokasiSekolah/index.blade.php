			...
			<div class="container news py-3">
				<div class="row">
                  ...
                  <th scope="col">Status</th>
                    ...
                    <td class="align-middle text-truncate max-width">{{$artikelData->alamat}}</td>
                    <td class="align-middle text-truncate max-width">{{$artikelData->phone}}</td>
                    ...
                    <td class="align-middle text-truncate max-width">{{$artikelData->maps}}</td>
                    <td class="align-middle text-truncate max-width">
                      @php
                      ...
                      @endphp
                        ...
                        <a href="{{url('/admin/lokasi-sekolah/'.base64_encode($artikelData->id).'/edit?view=true')}}" class="text-success">
                          <i class="fa fa-eye"></i>
                        </a>
                        <a href="{{url('/admin/lokasi-sekolah/'.base64_encode($artikelData->id).'/edit')}}" class="text-info mx-2">
