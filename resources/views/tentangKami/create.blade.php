...
<div class="card">
	<div class="card-body">
		<nav class="navbar bg-success" style="border-radius: 2px;">
			<h4 class="text-white mb-0">Tambah Tentang Kami</h4>
		</nav>
    <form class="col-lg-12 col-md-12 mt-4" action="{{url('/admin/tentang-kami/add')}}" method="post" enctype="multipart/form-data">
      @csrf
