                  ...
                  <th scope="col">Status</th>
                    ...
                    <td class="align-middle text-truncate max-width">
                      ...
                      @endphp
                        ...
                        <a href="{{url('/admin/gambar/'.base64_encode($artikelData->id).'/edit?view=true')}}" class="text-success">
                          <i class="fa fa-eye"></i>
                        </a>
                        <a href="{{url('/admin/gambar/'.base64_encode($artikelData->id).'/edit')}}" class="text-info mx-2">
